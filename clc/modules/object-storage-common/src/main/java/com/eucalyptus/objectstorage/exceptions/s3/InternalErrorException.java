...
public class InternalErrorException extends S3Exception {
  ...
  public InternalErrorException( String resource, String message ) {
    this( );
    this.setResource( resource );
  ...
  public InternalErrorException( String resource, Throwable cause ) {
    this( );
    this.setResource( resource );
    super.initCause( cause );
  }
