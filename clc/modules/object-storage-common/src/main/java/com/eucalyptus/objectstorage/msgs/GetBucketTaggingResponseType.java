...
public class GetBucketTaggingResponseType extends ObjectStorageResponseType implements BindingReplace<TaggingConfiguration> {
  ...
  private TaggingConfiguration taggingConfiguration;

  @Override
  public TaggingConfiguration bindingReplace( ) {
    return taggingConfiguration;
  }

  public TaggingConfiguration getTaggingConfiguration( ) {
    return taggingConfiguration;
  }

  public void setTaggingConfiguration( TaggingConfiguration taggingConfiguration ) {
