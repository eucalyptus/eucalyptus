...
public class DescribeCustomerGatewaysType extends VpcMessage {

  @HttpEmbedded
  private CustomerGatewayIdSetType customerGatewaySet;
  ...
  public void setCustomerGatewaySet( CustomerGatewayIdSetType customerGatewaySet ) {
