...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2SubnetAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2SubnetProperties;
 ...
 */
public class AWSEC2Subnet extends Resource {

  private AWSEC2SubnetProperties resourceProperties = new AWSEC2SubnetProperties();
  private AWSEC2SubnetAttributes resourceAttributes = new AWSEC2SubnetAttributes();
