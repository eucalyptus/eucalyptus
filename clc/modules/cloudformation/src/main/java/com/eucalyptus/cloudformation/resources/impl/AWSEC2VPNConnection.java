...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPNConnectionAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPNConnectionProperties;
 ...
 */
public class AWSEC2VPNConnection extends Resource {

  private AWSEC2VPNConnectionProperties resourceProperties = new AWSEC2VPNConnectionProperties();
  private AWSEC2VPNConnectionAttributes resourceAttributes = new AWSEC2VPNConnectionAttributes();


  public AWSEC2VPNConnection() {
