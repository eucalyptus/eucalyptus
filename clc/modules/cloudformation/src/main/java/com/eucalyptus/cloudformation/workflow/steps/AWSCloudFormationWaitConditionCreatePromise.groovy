...
public class AWSCloudFormationWaitConditionCreatePromise {
  ...
  public Promise<String> getCreatePromise(String resourceId, String stackId, String accountId, String effectiveUserId, int createdResourceVersion) {
    Promise<Integer> timeoutPromise =
        activities.getAWSCloudFormationWaitConditionTimeout(resourceId, stackId, accountId, effectiveUserId, createdResourceVersion)
