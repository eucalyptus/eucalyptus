...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSAutoScalingLaunchConfigurationAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSAutoScalingLaunchConfigurationProperties;
 ...
 */
public class AWSAutoScalingLaunchConfiguration extends Resource {

  private AWSAutoScalingLaunchConfigurationProperties resourceProperties = new AWSAutoScalingLaunchConfigurationProperties();
  private AWSAutoScalingLaunchConfigurationAttributes resourceAttributes = new AWSAutoScalingLaunchConfigurationAttributes();


  public AWSAutoScalingLaunchConfiguration() {
