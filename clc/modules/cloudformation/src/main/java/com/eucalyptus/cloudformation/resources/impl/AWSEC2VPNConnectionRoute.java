...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPNConnectionRouteAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPNConnectionRouteProperties;
 ...
 */
public class AWSEC2VPNConnectionRoute extends Resource {

  private AWSEC2VPNConnectionRouteProperties resourceProperties = new AWSEC2VPNConnectionRouteProperties();
  private AWSEC2VPNConnectionRouteAttributes resourceAttributes = new AWSEC2VPNConnectionRouteAttributes();


  public AWSEC2VPNConnectionRoute() {
