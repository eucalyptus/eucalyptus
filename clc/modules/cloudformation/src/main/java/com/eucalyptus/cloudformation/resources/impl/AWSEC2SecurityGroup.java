...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2SecurityGroupAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2SecurityGroupProperties;
 ...
 */
public class AWSEC2SecurityGroup extends Resource {

  private AWSEC2SecurityGroupProperties resourceProperties = new AWSEC2SecurityGroupProperties();
  private AWSEC2SecurityGroupAttributes resourceAttributes = new AWSEC2SecurityGroupAttributes();


  public AWSEC2SecurityGroup() {
