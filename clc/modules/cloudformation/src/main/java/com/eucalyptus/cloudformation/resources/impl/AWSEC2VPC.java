...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPCAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSEC2VPCProperties;
 ...
 */
public class AWSEC2VPC extends Resource {

  private AWSEC2VPCProperties resourceProperties = new AWSEC2VPCProperties();
  private AWSEC2VPCAttributes resourceAttributes = new AWSEC2VPCAttributes();
