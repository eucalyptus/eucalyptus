...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSCloudWatchAlarmAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSCloudWatchAlarmProperties;
 ...
 */
public class AWSCloudWatchAlarm extends Resource {

  private AWSCloudWatchAlarmProperties resourceProperties = new AWSCloudWatchAlarmProperties();
  private AWSCloudWatchAlarmAttributes resourceAttributes = new AWSCloudWatchAlarmAttributes();


  public AWSCloudWatchAlarm() {
