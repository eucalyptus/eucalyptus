...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSIAMAccessKeyAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSIAMAccessKeyProperties;
 ...
 */
public class AWSIAMAccessKey extends Resource {

  private AWSIAMAccessKeyProperties resourceProperties = new AWSIAMAccessKeyProperties();
  private AWSIAMAccessKeyAttributes resourceAttributes = new AWSIAMAccessKeyAttributes();


  public AWSIAMAccessKey() {
