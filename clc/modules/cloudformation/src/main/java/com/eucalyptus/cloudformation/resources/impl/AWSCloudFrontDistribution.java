...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSCloudFrontDistributionAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSCloudFrontDistributionProperties;
 ...
 */
public class AWSCloudFrontDistribution extends Resource {

  private AWSCloudFrontDistributionProperties resourceProperties = new AWSCloudFrontDistributionProperties();
  private AWSCloudFrontDistributionAttributes resourceAttributes = new AWSCloudFrontDistributionAttributes();


  public AWSCloudFrontDistribution() {
