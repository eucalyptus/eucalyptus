...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSElastiCacheSecurityGroupAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSElastiCacheSecurityGroupProperties;
 ...
 */
public class AWSElastiCacheSecurityGroup extends Resource {

  private AWSElastiCacheSecurityGroupProperties resourceProperties = new AWSElastiCacheSecurityGroupProperties();
  private AWSElastiCacheSecurityGroupAttributes resourceAttributes = new AWSElastiCacheSecurityGroupAttributes();


  public AWSElastiCacheSecurityGroup() {
