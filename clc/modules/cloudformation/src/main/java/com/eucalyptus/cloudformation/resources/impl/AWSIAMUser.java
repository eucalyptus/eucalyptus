...
import com.eucalyptus.cloudformation.resources.propertytypes.AWSIAMUserAttributes;
import com.eucalyptus.cloudformation.resources.propertytypes.AWSIAMUserProperties;
 ...
 */
public class AWSIAMUser extends Resource {

  private AWSIAMUserProperties resourceProperties = new AWSIAMUserProperties();
  private AWSIAMUserAttributes resourceAttributes = new AWSIAMUserAttributes();
