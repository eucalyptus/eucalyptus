...
public class GetSessionTokenResultType extends EucalyptusData {
  private CredentialsType credentials;

  public static GetSessionTokenResultType forCredentials( final String accessKeyId, final String secretAccessKey, final String sessionToken, final long expiryTime ) {
    ...
    final GetSessionTokenResultType getSessionTokenResult = new GetSessionTokenResultType( );
    getSessionTokenResult.setCredentials( credentials );
