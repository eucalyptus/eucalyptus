...
public class GetAccessTokenResponseType extends TokenMessage {
  private GetAccessTokenResultType result;
  private TokensResponseMetadataType responseMetadata = new TokensResponseMetadataType( );

  public GetAccessTokenResultType getResult() {
    return result;
  }

  public void setResult( GetAccessTokenResultType result ) {
    this.result = result;
  }
