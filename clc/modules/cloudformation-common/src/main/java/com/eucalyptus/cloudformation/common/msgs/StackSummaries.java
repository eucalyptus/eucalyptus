...
public class StackSummaries extends EucalyptusData {
  ...
  private ArrayList<StackSummary> member = new ArrayList<StackSummary>( );
  ...
  public ArrayList<StackSummary> getMember( ) {
    return member;
  }

  public void setMember( ArrayList<StackSummary> member ) {
    this.member = member;
  }
}
