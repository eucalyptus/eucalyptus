...
#define ARGUMENTS_VERSION "3.1.2"
#endif
...
struct eucalyptus_opts
{
  ...
  char * home_arg;	/**< @brief Eucalyptus home directory. (default='/disk1/eucalyptus/build/eucalyptus/').  */
  ...
  char * pidfile_arg;	/**< @brief Location for the pidfile. (default='/disk1/eucalyptus/build/eucalyptus/var/run/eucalyptus-cloud.pid').  */
  ...
  char ** java_home_arg;	/**< @brief Alternative way to specify JAVA_HOME. (default='/usr/lib/jvm/java-6-openjdk-amd64').  */
