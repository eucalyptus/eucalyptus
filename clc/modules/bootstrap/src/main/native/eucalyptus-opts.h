...
#define ARGUMENTS_VERSION "3.0.1"
#endif
...
struct eucalyptus_opts
{
  ...
  char * home_arg;	/**< @brief Eucalyptus home directory. (default='/opt/grze_eee_clc_dev/').  */
  ...
  char * pidfile_arg;	/**< @brief Location for the pidfile. (default='/opt/grze_eee_clc_dev/var/run/eucalyptus-cloud.pid').  */
