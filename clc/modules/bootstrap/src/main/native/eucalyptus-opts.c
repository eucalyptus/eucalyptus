...
const char *eucalyptus_opts_full_help[] = {
  ...
  "      --pidfile=FILENAME        Location for the pidfile.  \n                                  (default=`/disk1/eucalyptus/build/eucalyptus/var/run/eucalyptus-cloud.pid')",
...
init_help_array(void)
{
  ...
  eucalyptus_opts_help[13] = eucalyptus_opts_full_help[16];
  eucalyptus_opts_help[14] = eucalyptus_opts_full_help[17];
  eucalyptus_opts_help[15] = eucalyptus_opts_full_help[18];
  eucalyptus_opts_help[16] = eucalyptus_opts_full_help[19];
  eucalyptus_opts_help[17] = eucalyptus_opts_full_help[20];
  eucalyptus_opts_help[18] = eucalyptus_opts_full_help[21];
  eucalyptus_opts_help[19] = eucalyptus_opts_full_help[22];
  eucalyptus_opts_help[20] = eucalyptus_opts_full_help[23];
  eucalyptus_opts_help[21] = eucalyptus_opts_full_help[24];
  eucalyptus_opts_help[22] = eucalyptus_opts_full_help[25];
  eucalyptus_opts_help[23] = eucalyptus_opts_full_help[26];
  eucalyptus_opts_help[24] = eucalyptus_opts_full_help[27];
  ...
  eucalyptus_opts_help[33] = eucalyptus_opts_full_help[45];
...
void clear_args (struct eucalyptus_opts *args_info)
{
  ...
  args_info->home_arg = gengetopt_strdup ("/disk1/eucalyptus/build/eucalyptus/");
  ...
  args_info->pidfile_arg = gengetopt_strdup ("/disk1/eucalyptus/build/eucalyptus/var/run/eucalyptus-cloud.pid");
                        ...
                        struct arguments_params *params, const char *additional_error)
{
      ...
      switch (c)
        ...
        case 'h':	/* Eucalyptus home directory..  */
          ...
          if (update_arg( (void *)&(args_info->home_arg), 
              ...
              &(local_args_info.home_given), optarg, 0, "/disk1/eucalyptus/build/eucalyptus/", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "home", 'h',
              additional_error))
            goto failure;
        ...
        case 'j':	/* Alternative way to specify JAVA_HOME..  */
          ...
          if (update_multiple_arg_temp(&java_home_list, 
              &(local_args_info.java_home_given), optarg, 0, "/usr/lib/jvm/java-6-openjdk-amd64", ARG_STRING,
              "java-home", 'j',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "pidfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->pidfile_arg), 
                ...
                &(local_args_info.pidfile_given), optarg, 0, "/disk1/eucalyptus/build/eucalyptus/var/run/eucalyptus-cloud.pid", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "pidfile", '-',
                additional_error))
              goto failure;
  ...
  multiple_default_value.default_string_arg = "/usr/lib/jvm/java-6-openjdk-amd64";
