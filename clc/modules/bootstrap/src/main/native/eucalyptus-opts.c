...
const char *eucalyptus_opts_full_help[] = {
  ...
  "      --pidfile=FILENAME        Location for the pidfile.  \n                                  (default=`/opt/grze_eee_clc_dev/var/run/eucalyptus-cloud.pid')",
...
void clear_args (struct eucalyptus_opts *args_info)
{
  ...
  args_info->home_arg = gengetopt_strdup ("/opt/grze_eee_clc_dev/");
  ...
  args_info->pidfile_arg = gengetopt_strdup ("/opt/grze_eee_clc_dev/var/run/eucalyptus-cloud.pid");
                        ...
                        struct arguments_params *params, const char *additional_error)
{
      ...
      switch (c)
        ...
        case 'h':	/* Eucalyptus home directory..  */
          ...
          if (update_arg( (void *)&(args_info->home_arg), 
              ...
              &(local_args_info.home_given), optarg, 0, "/opt/grze_eee_clc_dev/", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "home", 'h',
              additional_error))
            goto failure;
        ...
        case 'j':	/* Alternative way to specify JAVA_HOME..  */
          ...
          if (update_multiple_arg_temp(&java_home_list, 
              &(local_args_info.java_home_given), optarg, 0, "/bzr/packages/jdk1.6.0_26/", ARG_STRING,
              "java-home", 'j',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "pidfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->pidfile_arg), 
                ...
                &(local_args_info.pidfile_given), optarg, 0, "/opt/grze_eee_clc_dev/var/run/eucalyptus-cloud.pid", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "pidfile", '-',
                additional_error))
              goto failure;
  ...
  multiple_default_value.default_string_arg = "/bzr/packages/jdk1.6.0_26/";
