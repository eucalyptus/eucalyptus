...
public class WalrusImageUtils {
  ...
  public static long untarImage(String tarredImageName, String imageName) throws Exception {
    /*
     * TarInputStream in = new TarInputStream(new FileInputStream(new File(tarredImageName))); File outFile = new File(imageName);
     * BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(outFile));
     * 
     * TarEntry tEntry = in.getNextEntry(); assert(!tEntry.isDirectory());
     * 
     * in.copyEntryContents(out); out.close(); in.close(); return outFile.length();
     */
