...
public class ListInstanceProfilesResponseType extends EuareMessage {
  ...
  private ListInstanceProfilesResult listInstanceProfilesResult = new ListInstanceProfilesResult( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public ListInstanceProfilesResult getListInstanceProfilesResult( ) {
    return listInstanceProfilesResult;
  }

  public void setListInstanceProfilesResult( ListInstanceProfilesResult listInstanceProfilesResult ) {
