...
public class CreateInstanceProfileResponseType extends EuareMessage {
  ...
  private CreateInstanceProfileResult createInstanceProfileResult = new CreateInstanceProfileResult( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public CreateInstanceProfileResult getCreateInstanceProfileResult( ) {
    return createInstanceProfileResult;
  }

  public void setCreateInstanceProfileResult( CreateInstanceProfileResult createInstanceProfileResult ) {
