...
public class ListGroupsResponseType extends EuareMessage {
  ...
  private ListGroupsResultType listGroupsResult = new ListGroupsResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public ListGroupsResultType getListGroupsResult( ) {
    return listGroupsResult;
  }

  public void setListGroupsResult( ListGroupsResultType listGroupsResult ) {
