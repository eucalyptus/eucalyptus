...
public class CreateGroupResponseType extends EuareMessage {
  ...
  private CreateGroupResultType createGroupResult = new CreateGroupResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public CreateGroupResultType getCreateGroupResult( ) {
    return createGroupResult;
  }

  public void setCreateGroupResult( CreateGroupResultType createGroupResult ) {
