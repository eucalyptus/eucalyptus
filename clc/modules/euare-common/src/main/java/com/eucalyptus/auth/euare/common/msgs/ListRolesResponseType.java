...
public class ListRolesResponseType extends EuareMessage {
  ...
  private ListRolesResult listRolesResult = new ListRolesResult( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public ListRolesResult getListRolesResult( ) {
    return listRolesResult;
  }

  public void setListRolesResult( ListRolesResult listRolesResult ) {
