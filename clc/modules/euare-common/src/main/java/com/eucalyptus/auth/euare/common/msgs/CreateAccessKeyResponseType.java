...
public class CreateAccessKeyResponseType extends EuareMessage {
  ...
  private CreateAccessKeyResultType createAccessKeyResult = new CreateAccessKeyResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public CreateAccessKeyResultType getCreateAccessKeyResult( ) {
    return createAccessKeyResult;
  }

  public void setCreateAccessKeyResult( CreateAccessKeyResultType createAccessKeyResult ) {
