...
public class GetInstanceProfileResponseType extends EuareMessage {
  ...
  private GetInstanceProfileResult getInstanceProfileResult = new GetInstanceProfileResult( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public GetInstanceProfileResult getGetInstanceProfileResult( ) {
    return getInstanceProfileResult;
  }

  public void setGetInstanceProfileResult( GetInstanceProfileResult getInstanceProfileResult ) {
