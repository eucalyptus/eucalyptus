...
public class CreateAccountResponseType extends EuareMessage {
  ...
  private CreateAccountResultType createAccountResult = new CreateAccountResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public CreateAccountResultType getCreateAccountResult( ) {
    return createAccountResult;
  }

  public void setCreateAccountResult( CreateAccountResultType createAccountResult ) {
