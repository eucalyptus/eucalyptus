...
public class GetRolePolicyResponseType extends EuareMessage {
  ...
  private GetRolePolicyResult getRolePolicyResult = new GetRolePolicyResult( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public GetRolePolicyResult getGetRolePolicyResult( ) {
    return getRolePolicyResult;
  }

  public void setGetRolePolicyResult( GetRolePolicyResult getRolePolicyResult ) {
    this.getRolePolicyResult = getRolePolicyResult;
  }
