...
public class CreateUserResponseType extends EuareMessage {
  ...
  private CreateUserResultType createUserResult = new CreateUserResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public CreateUserResultType getCreateUserResult( ) {
    return createUserResult;
  }

  public void setCreateUserResult( CreateUserResultType createUserResult ) {
