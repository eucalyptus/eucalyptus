...
public class ListAccessKeysResponseType extends EuareMessage {
  ...
  private ListAccessKeysResultType listAccessKeysResult = new ListAccessKeysResultType( );
  private ResponseMetadataType responseMetadata = new ResponseMetadataType( );

  public ListAccessKeysResultType getListAccessKeysResult( ) {
    return listAccessKeysResult;
  }

  public void setListAccessKeysResult( ListAccessKeysResultType listAccessKeysResult ) {
    this.listAccessKeysResult = listAccessKeysResult;
  }
