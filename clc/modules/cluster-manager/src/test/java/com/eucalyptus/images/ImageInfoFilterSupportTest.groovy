...
class ImageInfoFilterSupportTest extends FilterSupportTest.InstanceTest<ImageInfo> {
  ...
  void testPredicateFilters() {
    ...
    assertMatch(true, "block-device-mapping.delete-on-termination", "true", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(delete: true) ] as Set))
    assertMatch(true, "block-device-mapping.delete-on-termination", "true", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(delete: true), new BlockStorageDeviceMapping(delete: false) ] as Set))
    assertMatch(true, "block-device-mapping.delete-on-termination", "false", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(delete: true), new BlockStorageDeviceMapping(delete: false) ] as Set))
    assertMatch(false, "block-device-mapping.delete-on-termination", "true", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(delete: false) ] as Set ))
    assertMatch(false, "block-device-mapping.delete-on-termination", "true", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping() ] as Set ))
    assertMatch(false, "block-device-mapping.delete-on-termination", "true", new ImageInfo(deviceMappings: [] as Set ))
    assertMatch(false, "block-device-mapping.delete-on-termination", "true", new ImageInfo())

    assertMatch(true, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(deviceName: "/dev/sdb1") ] as Set))
    assertMatch(true, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(deviceName: "/dev/sdb1"), new BlockStorageDeviceMapping(deviceName: "/dev/sdb2") ] as Set))
    assertMatch(true, "block-device-mapping.device-name", "/dev/sdb2", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(deviceName: "/dev/sdb1"), new BlockStorageDeviceMapping(deviceName: "/dev/sdb2") ] as Set))
    assertMatch(false, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(deviceName: "/dev/sdb2") ] as Set ))
    assertMatch(false, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping() ] as Set ))
    assertMatch(false, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo(deviceMappings: [] as Set ))
    assertMatch(false, "block-device-mapping.device-name", "/dev/sdb1", new ImageInfo())

    assertMatch(true, "block-device-mapping.snapshot-id", "snap-00000001", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(snapshotId:  "snap-00000001") ] as Set))
    assertMatch(false, "block-device-mapping.snapshot-id", "snap-00000001", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(snapshotId: "snap-00000002") ] as Set ))

    assertMatch(true, "block-device-mapping.volume-size", "1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(size: 1) ] as Set))
    assertMatch(false, "block-device-mapping.volume-size", "1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping(size: 2) ] as Set ))
    assertMatch(false, "block-device-mapping.volume-size", "1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping() ] as Set ))

    assertMatch(true, "block-device-mapping.volume-type", "standard", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping() ] as Set))
    assertMatch(false, "block-device-mapping.volume-type", "io1", new ImageInfo(deviceMappings: [ new BlockStorageDeviceMapping() ] as Set ) )
