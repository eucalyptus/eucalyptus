...
public class EucalyptusActivityTasks {
  private static final Logger LOG = Logger
      .getLogger(EucalyptusActivityTask.class);
  ...
  private class EuareSystemActivity implements
      ActivityContext<EuareMessage, Euare> {
    ...
    public DispatchingClient<EuareMessage, Euare> getClient() {
      try {
        final DispatchingClient<EuareMessage, Euare> client = new DispatchingClient<>(
            this.getUserId(), Euare.class);
        client.init();
        return client;
      } catch (Exception ex) {
        throw Exceptions.toUndeclared(ex);
  ...
  private class EuareUserActivity implements
      ActivityContext<EuareMessage, Euare> {
    private String userId = null;

    private EuareUserActivity(final String userId) {
      this.userId = userId;
    }
  ...
  private class AutoScalingSystemActivity implements
      ActivityContext<AutoScalingMessage, AutoScaling> {
    ...
    public DispatchingClient<AutoScalingMessage, AutoScaling> getClient() {
      try {
        final DispatchingClient<AutoScalingMessage, AutoScaling> client = new DispatchingClient<>(
            this.getUserId(), AutoScaling.class);
        client.init();
        return client;
      } catch (Exception ex) {
        throw Exceptions.toUndeclared(ex);
  ...
  private class EmpyreanSystemActivity implements
      ActivityContext<EmpyreanMessage, Empyrean> {
    ...
    public DispatchingClient<EmpyreanMessage, Empyrean> getClient() {
      try {
        final DispatchingClient<EmpyreanMessage, Empyrean> client = new DispatchingClient<>(
            this.getUserId(), Empyrean.class);
        client.init();
        return client;
      } catch (Exception e) {
  ...
  private class EucalyptusBaseSystemActivity implements
      ActivityContext<BaseMessage, Eucalyptus> {
    @Override
    public String getUserId() {
      try {
        // ASSUMING THE SERVICE HAS ACCESS TO LOCAL DB
    ...
    public DispatchingClient<BaseMessage, Eucalyptus> getClient() {
      try {
        final DispatchingClient<BaseMessage, Eucalyptus> client = new DispatchingClient<>(
            this.getUserId(), Eucalyptus.class);
        client.init();
        return client;
      } catch (Exception e) {
  ...
  public void terminateSystemInstance(final String instanceId) {
    ...
    final EucalyptusTerminateInstanceTask describeTask = new EucalyptusTerminateInstanceTask(
        instanceId);
    final CheckedListenableFuture<Boolean> result = describeTask
        .dispatch(new EucalyptusSystemActivity());
    try {
      if (result.get()) {
        return;
      } else
  ...
  public List<RunningInstancesItemType> describeSystemInstances(
      final List<String> instances) {
    if (instances.size() <= 0)
      return Lists.newArrayList();
    final EucalyptusDescribeInstanceTask describeTask = new EucalyptusDescribeInstanceTask(
        instances);
    final CheckedListenableFuture<Boolean> result = describeTask
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public List<RunningInstancesItemType> describeUserInstances(
    ...
    final EucalyptusDescribeInstanceTask describeTask = new EucalyptusDescribeInstanceTask(
        instances);
    final CheckedListenableFuture<Boolean> result = describeTask
        .dispatch(new EucalyptusUserActivity(userId));
  ...
  public List<ServiceStatusType> describeServices(final String componentType) {
    ...
    final CheckedListenableFuture<Boolean> result = serviceTask
        .dispatch(new EmpyreanSystemActivity());
    try {
      if (result.get()) {
  ...
  public List<VmTypeDetails> describeVMTypes() {
    ...
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusBaseSystemActivity());
    try {
      if (result.get()) {
  ...
  public void createSecurityGroup(String groupName, String groupDesc) {
    final EucalyptusCreateGroupTask task = new EucalyptusCreateGroupTask(
        groupName, groupDesc);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public void deleteSecurityGroup(String groupName) {
    final EucalyptusDeleteGroupTask task = new EucalyptusDeleteGroupTask(
        groupName);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public List<SecurityGroupItemType> describeSecurityGroups(
    ...
    final EucalyptusDescribeSecurityGroupTask task = new EucalyptusDescribeSecurityGroupTask(
        groupNames);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public void authorizeSecurityGroup(String groupName, String protocol,
      int portNum) {
    final EucalyptusAuthorizeIngressRuleTask task = new EucalyptusAuthorizeIngressRuleTask(
  ...
  public void revokeSecurityGroup(String groupName, String protocol, int portNum) {
    final EucalyptusRevokeIngressRuleTask task = new EucalyptusRevokeIngressRuleTask(
        groupName, protocol, portNum);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public void createLaunchConfiguration(final String imageId,
    ...
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new AutoScalingSystemActivity());
    try {
      if (result.get()) {
        return;
      } else
  ...
  public void createAutoScalingGroup(final String groupName,
    ...
    final AutoScalingCreateGroupTask task = new AutoScalingCreateGroupTask(
        groupName, availabilityZones, capacity, launchConfigName);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new AutoScalingSystemActivity());
    try {
      if (result.get()) {
  ...
  public LaunchConfigurationType describeLaunchConfiguration(
      final String launchConfigName) {
  ...
  public void deleteAutoScalingGroup(final String groupName,
  ...
  public void updateAutoScalingGroup(final String groupName,
  ...
  public void updateAutoScalingGroup(final String groupName,
    ...
    try {
      if (result.get()) {
        ...
        throw new EucalyptusActivityException(
            "failed to enable zones in autoscaling group");
    } catch (Exception ex) {
      throw Exceptions.toUndeclared(ex);
    }
  }
  ...
  public List<RoleType> listRoles(final String pathPrefix) {
    ...
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EuareSystemActivity());
    try {
      if (result.get()) {
  ...
  public List<SubnetType> describeSubnetsAsUser(final String userId,
    ...
    try {
      ...
      final DescribeSubnetsResponseType response = AsyncRequests.sendSync(
          Eucalyptus.class, describeSubnetsType);
  ...
  public List<DescribeKeyPairsResponseItemType> describeKeyPairsAsUser(
      final String userId, final List<String> keyNames) {
    final EucaDescribeKeyPairsTask task = new EucaDescribeKeyPairsTask(keyNames);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusUserActivity(userId));
    try {
      if (result.get()) {
  ...
  public ServerCertificateType getServerCertificate(final String userId,
    ...
    final EuareGetServerCertificateTask task = new EuareGetServerCertificateTask(
        certName);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EuareUserActivity(userId));
    try {
      if (result.get()) {
  ...
  public InstanceProfileType createInstanceProfile(String profileName,
      String path) {
  ...
  public void addRoleToInstanceProfile(String instanceProfileName,
      String roleName) {
  ...
  public void removeRoleFromInstanceProfile(String instanceProfileName,
      String roleName) {
  ...
  public void putRolePolicy(String roleName, String policyName,
  ...
  public List<ImageDetails> describeImages(final List<String> imageIds,
    ...
    final EucaDescribeImagesTask task = new EucaDescribeImagesTask(imageIds);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
      if (result.get()) {
  ...
  public void createTags(final String tagKey, final String tagValue,
      final List<String> resources) {
    final EucaCreateTagsTask task = new EucaCreateTagsTask(tagKey, tagValue,
        resources);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public void deleteTags(final String tagKey, final String tagValue,
      final List<String> resources) {
    final EucaDeleteTagsTask task = new EucaDeleteTagsTask(tagKey, tagValue,
        resources);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusSystemActivity());
    try {
  ...
  public void deleteAutoscalingTags(final String tagKey, final String tagValue,
  ...
  public void uploadServerCertificate(final String certName,
      final String certPath, final String certBodyPem, final String pkPem,
      final String certChainPem) {
    final UploadServerCertificateTask task = new UploadServerCertificateTask(
        certName, certPath, certBodyPem, pkPem, certChainPem);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EuareSystemActivity());
    try {
      if (result.get()) {
        ...
        throw new EucalyptusActivityException(
            "failed to upload server certificate");
    } catch (Exception ex) {
      throw Exceptions.toUndeclared(ex);
    }
  }
  ...
  public void deleteServerCertificate(final String certName) {
    final DeleteServerCertificateTask task = new DeleteServerCertificateTask(
        certName);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EuareSystemActivity());
    try {
      if (result.get()) {
        ...
        throw new EucalyptusActivityException(
            "failed to delete server certificate");
    } catch (Exception ex) {
      throw Exceptions.toUndeclared(ex);
    }
  }

  public List<TagInfo> describeTags(final List<String> names,
  ...
  public String createVolumeAsUser(final String userId,
      final String availabilityZone, final int size) {
  ...
  public List<Volume> describeVolumesAsUser(final String userId,
  ...
  public String runInstancesAsUser(final String userId, final String imageId,
      final Set<String> groupNames, final String userData,
    ...
    final EucalyptusRunInstancesTask task = new EucalyptusRunInstancesTask(
        imageId);
  ...
  public List<Snapshot> describeSnapshotsAsUser(final String userId,
      final List<String> snapshotIds) {
    final EucalyptusDescribeSnapshotsTask task = new EucalyptusDescribeSnapshotsTask(
        snapshotIds);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusUserActivity(userId));
    try {
  ...
  public String registerEBSImageAsUser(final String userId,
    ...
    final EucalyptusRegisterEBSImageTask task = new EucalyptusRegisterEBSImageTask(
  ...
  public String createSnapshotAsUser(final String userId, final String volumeId) {
    ...
    final EucalyptusCreateSnapshotTask task = new EucalyptusCreateSnapshotTask(
        volumeId);
    final CheckedListenableFuture<Boolean> result = task
        .dispatch(new EucalyptusUserActivity(userId));
    try {
  ...
  private class EucalyptusRegisterEBSImageTask extends
    ...
    private EucalyptusRegisterEBSImageTask(final String snapshotId,
  ...
  private class DeleteServerCertificateTask extends
      EucalyptusActivityTask<EuareMessage, Euare> {
  ...
  private class UploadServerCertificateTask extends
      EucalyptusActivityTask<EuareMessage, Euare> {
    private String certName = null;
    ...
    private UploadServerCertificateTask(final String certName,
        final String certPath, final String certPem, final String pkPem,
  ...
  private class AutoscalingDeleteTagsTask extends
      EucalyptusActivityTask<AutoScalingMessage, AutoScaling> {
  ...
  private class AutoScalingDescribeTagsTask extends
      EucalyptusActivityTask<AutoScalingMessage, AutoScaling> {
    ...
    private com.eucalyptus.autoscaling.common.msgs.DescribeTagsType describeTags() {
      final com.eucalyptus.autoscaling.common.msgs.DescribeTagsType req = new com.eucalyptus.autoscaling.common.msgs.DescribeTagsType();
      return req;
    }
    ...
    void dispatchSuccess(
        ActivityContext<AutoScalingMessage, AutoScaling> context,
        AutoScalingMessage response) {
      com.eucalyptus.autoscaling.common.msgs.DescribeTagsResponseType resp = (com.eucalyptus.autoscaling.common.msgs.DescribeTagsResponseType) response;
      if (resp.getDescribeTagsResult() != null
          && resp.getDescribeTagsResult().getTags() != null)
  ...
  private class AutoScalingCreateGroupTask extends
    ...
    private AutoScalingCreateGroupTask(final String groupName,
        final List<String> zones, final int capacity, final String launchConfig) {
      this.groupName = groupName;
      this.availabilityZones = zones;
      this.capacity = capacity;
      this.launchConfigName = launchConfig;
  ...
  private class EucalyptusDescribeVMTypesTask extends
      EucalyptusActivityTask<BaseMessage, Eucalyptus> {
    ...
    @Override
    void dispatchInternal(ActivityContext<BaseMessage, Eucalyptus> context,
    ...
    @Override
    void dispatchSuccess(ActivityContext<BaseMessage, Eucalyptus> context,
  ...
  private class EucalyptusDescribeServicesTask extends
      EucalyptusActivityTask<EmpyreanMessage, Empyrean> {
    ...
    @Override
    void dispatchInternal(ActivityContext<EmpyreanMessage, Empyrean> context,
    ...
    @Override
    void dispatchSuccess(ActivityContext<EmpyreanMessage, Empyrean> context,
  ...
  private class EucalyptusAuthorizeIngressRuleTask extends
    ...
    EucalyptusAuthorizeIngressRuleTask(String groupName, String protocol,
        int portNum) {
  ...
  private class EucalyptusRevokeIngressRuleTask extends
    ...
    EucalyptusRevokeIngressRuleTask(String groupName, String protocol,
        int portNum) {
      this.groupName = groupName;
      this.protocol = protocol;
      this.portNum = portNum;
  ...
  private abstract class EucalyptusActivityTask<TM extends BaseMessage, TC extends ComponentId> {
    ...
    abstract void dispatchInternal(ActivityContext<TM, TC> context,
