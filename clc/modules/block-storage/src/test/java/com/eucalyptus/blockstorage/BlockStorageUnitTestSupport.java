    ...
    public static void setupBlockStoragePersistenceContext() {
        ...
        Ejb3Configuration config =
                (new Ejb3Configuration()).configure(props)
                        .addAnnotatedClass(BlockStorageGlobalConfiguration.class)
                        .addAnnotatedClass(CHAPUserInfo.class)
                        .addAnnotatedClass(DASInfo.class)
                        .addAnnotatedClass(DirectStorageInfo.class)
                        .addAnnotatedClass(ISCSIMetaInfo.class)
                        .addAnnotatedClass(ISCSIVolumeInfo.class)
                        .addAnnotatedClass(SnapshotInfo.class)
                        .addAnnotatedClass(SnapshotPart.class)
                        .addAnnotatedClass(SnapshotTransferConfiguration.class)
                        .addAnnotatedClass(SnapshotUploadInfo.class)
