...
public class DatabaseServerProperties {
   ...
   public static class EnabledChangeListener implements PropertyChangeListener<String> {
     @Override
   ...
   public static class VolumeChangeListener implements PropertyChangeListener<String> {
    @Override
