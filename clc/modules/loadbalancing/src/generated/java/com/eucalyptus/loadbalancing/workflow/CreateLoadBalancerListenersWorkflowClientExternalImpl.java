...
class CreateLoadBalancerListenersWorkflowClientExternalImpl extends WorkflowClientExternalBase implements CreateLoadBalancerListenersWorkflowClientExternal {

    public CreateLoadBalancerListenersWorkflowClientExternalImpl(WorkflowExecution workflowExecution, WorkflowType workflowType, 
            StartWorkflowOptions options, DataConverter dataConverter, GenericWorkflowClientExternal genericClient) {
        super(workflowExecution, workflowType, options, dataConverter, genericClient);
    }

    @Override
    public void createLoadBalancerListeners(String accountId, String loadbalancer, com.eucalyptus.loadbalancing.common.msgs.Listener[] listeners) { 
        createLoadBalancerListeners(accountId, loadbalancer, listeners, null);
    }

    @Override
    public void createLoadBalancerListeners(String accountId, String loadbalancer, com.eucalyptus.loadbalancing.common.msgs.Listener[] listeners, StartWorkflowOptions startOptionsOverride) {
    
        Object[] _arguments_ = new Object[3]; 
        _arguments_[0] = accountId;
        _arguments_[1] = loadbalancer;
        _arguments_[2] = listeners;
