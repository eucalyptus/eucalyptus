...
class DeleteLoadBalancerWorkflowClientExternalImpl extends WorkflowClientExternalBase implements DeleteLoadBalancerWorkflowClientExternal {

    public DeleteLoadBalancerWorkflowClientExternalImpl(WorkflowExecution workflowExecution, WorkflowType workflowType, 
            StartWorkflowOptions options, DataConverter dataConverter, GenericWorkflowClientExternal genericClient) {
        super(workflowExecution, workflowType, options, dataConverter, genericClient);
    }

    @Override
    public void deleteLoadBalancer(String accountId, String loadbalancer) { 
        deleteLoadBalancer(accountId, loadbalancer, null);
    }

    @Override
    public void deleteLoadBalancer(String accountId, String loadbalancer, StartWorkflowOptions startOptionsOverride) {
