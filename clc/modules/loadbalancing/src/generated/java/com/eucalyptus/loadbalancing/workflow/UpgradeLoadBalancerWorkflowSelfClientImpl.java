...
public class UpgradeLoadBalancerWorkflowSelfClientImpl extends WorkflowSelfClientBase implements UpgradeLoadBalancerWorkflowSelfClient {

    public UpgradeLoadBalancerWorkflowSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public UpgradeLoadBalancerWorkflowSelfClientImpl(GenericWorkflowClient genericClient) {
    ...
    @Override
    public final void upgradeLoadBalancer() { 
        upgradeLoadBalancerImpl(null);
    }
    
    @Override
    public final void upgradeLoadBalancer(StartWorkflowOptions optionsOverride, Promise<?>... waitFor) {
        upgradeLoadBalancerImpl(optionsOverride, waitFor);
    }
    
    protected void upgradeLoadBalancerImpl(final StartWorkflowOptions schedulingOptionsOverride, Promise<?>... waitFor) {
    	new Task(waitFor) {
    		@Override
