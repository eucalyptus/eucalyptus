...
class DisableAvailabilityZoneWorkflowClientExternalImpl extends WorkflowClientExternalBase implements DisableAvailabilityZoneWorkflowClientExternal {

    public DisableAvailabilityZoneWorkflowClientExternalImpl(WorkflowExecution workflowExecution, WorkflowType workflowType, 
            StartWorkflowOptions options, DataConverter dataConverter, GenericWorkflowClientExternal genericClient) {
        super(workflowExecution, workflowType, options, dataConverter, genericClient);
    }

    @Override
    public void disableAvailabilityZone(String accountId, String loadbalancer, java.util.List<java.lang.String> availabilityZones) { 
        disableAvailabilityZone(accountId, loadbalancer, availabilityZones, null);
    }

    @Override
    public void disableAvailabilityZone(String accountId, String loadbalancer, java.util.List<java.lang.String> availabilityZones, StartWorkflowOptions startOptionsOverride) {
