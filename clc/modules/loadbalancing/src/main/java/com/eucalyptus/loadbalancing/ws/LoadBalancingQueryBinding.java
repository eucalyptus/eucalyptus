...
public class LoadBalancingQueryBinding extends BaseQueryBinding<OperationParameter> {
  ...
  static final String LOADBALANCING_NAMESPACE_PATTERN = "http://elasticloadbalancing.amazonaws.com/doc/%s/";    
  static final String LOADBALANCING_DEFAULT_VERSION = "2012-06-01";        
