...
public class LoadBalancingServoCache {
  ...
  public LoadBalancerServoDescription lookupServoDescription(final String instanceId ) {
    ...
    try{
      backendServers = 
          this.getLoadBalancerBackendServerDescriptions(instanceId);
    }catch(final Exception ex) {
      ;
    }
    ...
    return LoadBalancers.getServoDescription(lb, 
        zone, 
        lbListeners, 
        backendServers, 
        lbPolicies);
