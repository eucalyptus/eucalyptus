...
public class MetricTest {
	...
	public static void addStuff() {
		...
		MetricManager.addMetric("account1", "user1", "metric1", "name1", null, MetricType.Custom, Units.None, new Date(), 1.0, 1.0, 1.0, 1.0);
		MetricManager.addMetric("account1", "user1", "metric1", "name1", dimensionMap1, MetricType.System, Units.BitsPerSecond, new Date(System.currentTimeMillis() - 10000000), 1.0, 2.0, 2.0, 2.0);
		MetricManager.addMetric("account1", "user1", "metric1", "name1", dimensionMap2, MetricType.System, Units.Count, new Date(System.currentTimeMillis() - 20000000), 1.0, 3.0, 3.0, 3.0);
		MetricManager.addMetric("account1", "user1", "metric1", "name1", dimensionMap3, MetricType.System, Units.Count, new Date(System.currentTimeMillis() - 20000000), 1.0, 3.0, 3.0, 3.0);
		MetricManager.addMetric("account1", "user1", "metric1", "name1", dimensionMap4, MetricType.System, Units.Count, new Date(System.currentTimeMillis() - 20000000), 1.0, 3.0, 3.0, 3.0);
