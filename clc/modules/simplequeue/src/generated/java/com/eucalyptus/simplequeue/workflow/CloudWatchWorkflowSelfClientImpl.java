...
public class CloudWatchWorkflowSelfClientImpl extends WorkflowSelfClientBase implements CloudWatchWorkflowSelfClient {

    public CloudWatchWorkflowSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public CloudWatchWorkflowSelfClientImpl(GenericWorkflowClient genericClient) {
    ...
    public final void sendMetrics() { 
        sendMetricsImpl(null);
    }
    
    @Override
    public final void sendMetrics(StartWorkflowOptions optionsOverride, Promise<?>... waitFor) {
        sendMetricsImpl(optionsOverride, waitFor);
    }
    
    protected void sendMetricsImpl(final StartWorkflowOptions schedulingOptionsOverride, Promise<?>... waitFor) {
    	new Task(waitFor) {
    		@Override
