...
public class DbBucketTaggingManagerImpl implements BucketTaggingManager {
  ...
  @Override
  public void addBucketTagging( @Nonnull List<BucketTag> tags,
    ...
    try( TransactionResource tx = Entities.transactionFor( BucketTags.class ) ) {
      ...
      throw new ObjectStorageException("InternalServerError",
              "An exception was caught while adding TagSet for bucket - " + bucketUuid,
  ...
  public void deleteBucketTagging( @Nonnull String bucketUuid ) throws ObjectStorageException {
    try ( TransactionResource tx = Entities.transactionFor( BucketTags.class ) ) {
      ...
      throw new ObjectStorageException("InternalServerError",
              "An exception was caught while deleting TagSet for bucket - " + bucketUuid,
              "Bucket", bucketUuid, HttpResponseStatus.INTERNAL_SERVER_ERROR);
    }
  }

  @Override
  public List<BucketTags> getBucketTagging( @Nonnull String bucketUuid )
          throws NoSuchEntityException, ObjectStorageException {
