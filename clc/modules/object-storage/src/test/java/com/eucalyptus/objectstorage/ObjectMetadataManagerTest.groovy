...
public class ObjectMetadataManagerTest {
    ...
    public void testConcurrentPut() {
        ...
        objMgr.lookupObjectsInState(bucket, key, null, ObjectState.creating).each {
            println it.getObjectUuid() + ' - ' + it.getObjectModifiedTimestamp()
        }
        ...
        objMgr.lookupObjectsInState(bucket, key, null, ObjectState.extant).each {
            println it.getObjectUuid() + ' - ' + it.getObjectModifiedTimestamp()
        }
    }
