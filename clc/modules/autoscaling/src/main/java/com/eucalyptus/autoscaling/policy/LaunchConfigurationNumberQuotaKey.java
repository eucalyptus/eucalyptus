...
public class LaunchConfigurationNumberQuotaKey extends QuotaKey {
  ...
  public boolean canApply( String action, String resourceType ) {
    return PolicySpec.qualifiedName( 
        ...
        PolicySpec.AUTOSCALING_CREATELAUNCHCONFIGURATION ).equals( action );
  }
  ...
  public String value( Scope scope, String id, String resource, Long quantity ) throws AuthException {
    switch ( scope ) {
      case ACCOUNT:
        return Long.toString( RestrictedTypes.quantityMetricFunction( LaunchConfigurationMetadata.class ).apply( AccountFullName.getInstance( id ) ) + 1 );
      case GROUP:
        return NOT_SUPPORTED;
      case USER:
        return Long.toString( RestrictedTypes.quantityMetricFunction( LaunchConfigurationMetadata.class ).apply( UserFullName.getInstance( id ) ) + 1 );
    }
