...
public class EmpyreanTransactionManager implements org.jboss.cache.transaction.TransactionManagerLookup, org.hibernate.transaction.TransactionManagerLookup {
  ...
  private static void configureTm( ) {
...
//    tm_conf.setJndiUserTransactionName(  )
  }
