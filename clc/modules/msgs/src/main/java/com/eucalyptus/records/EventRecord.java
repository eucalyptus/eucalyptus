...
public abstract class EventRecord {
  private static EucalyptusMessage BOGUS  = new EucalyptusMessage( ) {{
    setUserId( null );
  ...
  private static class LogFileRecord extends EventRecord {
    ...
    private LogFileRecord( final String component, final String eventUserId, final String eventCorrelationId, final String eventId, final String other, int distance ) {
