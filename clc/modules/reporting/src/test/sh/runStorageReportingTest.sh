...
wget -O /tmp/storageReport.csv --no-check-certificate "https://localhost:8443/reports?session=$SESSIONID&name=user_storage&type=csv&page=0&flush=false&start=1104580000000&end=1104590000000&criterionId=2&groupById=0"
