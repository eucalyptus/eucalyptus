 ...
 *   beginMs		: LONG
 *   endMs			: LONG
 *   +zones			: ARRAY (of AvailabilityZone)
...
public class AbstractReportingTreeFactory
{
	...
	public void scan()
	{
		...
		while (iter.hasNext()) {
			...
			log.debug("  --> Found reporting instance create event uuid:" + createEvent.getUuid());
		}
		...
		while (iter.hasNext()) {
			...
			log.debug("  --> Found reporting instance usage event uuid:" + usageEvent.getUuid());
		}
	}

//	public ArtObject getArt(Period period, ReportingCriterion[] criteria)
//	{
//		return null;
//		/* Generate a report
//		 */
