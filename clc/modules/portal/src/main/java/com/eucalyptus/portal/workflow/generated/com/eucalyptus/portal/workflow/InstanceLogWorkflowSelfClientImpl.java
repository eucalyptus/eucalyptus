...
public class InstanceLogWorkflowSelfClientImpl extends WorkflowSelfClientBase implements InstanceLogWorkflowSelfClient {

    public InstanceLogWorkflowSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public InstanceLogWorkflowSelfClientImpl(GenericWorkflowClient genericClient) {
    ...
    @Override
    public final void logInstanceHourly() { 
        logInstanceHourlyImpl(null);
    }
    
    @Override
    public final void logInstanceHourly(StartWorkflowOptions optionsOverride, Promise<?>... waitFor) {
        logInstanceHourlyImpl(optionsOverride, waitFor);
    }
    
    protected void logInstanceHourlyImpl(final StartWorkflowOptions schedulingOptionsOverride, Promise<?>... waitFor) {
    	new Task(waitFor) {
    		@Override
