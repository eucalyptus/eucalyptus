...
public class ResourceUsageEventWorkflowSelfClientImpl extends WorkflowSelfClientBase implements ResourceUsageEventWorkflowSelfClient {

    public ResourceUsageEventWorkflowSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public ResourceUsageEventWorkflowSelfClientImpl(GenericWorkflowClient genericClient) {
    ...
    @Override
    public final void fireEvents(StartWorkflowOptions optionsOverride, Promise<?>... waitFor) {
        fireEventsImpl(optionsOverride, waitFor);
    }
    
    protected void fireEventsImpl(final StartWorkflowOptions schedulingOptionsOverride, Promise<?>... waitFor) {
    	new Task(waitFor) {
    		@Override
