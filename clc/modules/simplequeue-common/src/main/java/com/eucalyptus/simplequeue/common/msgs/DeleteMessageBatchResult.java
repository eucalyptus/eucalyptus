...
public class DeleteMessageBatchResult extends EucalyptusData {
  ...
  private ArrayList<DeleteMessageBatchResultEntry> deleteMessageBatchResultEntry = new ArrayList<DeleteMessageBatchResultEntry>( );
  private ArrayList<BatchResultErrorEntry> batchResultErrorEntry = new ArrayList<BatchResultErrorEntry>( );

  public ArrayList<DeleteMessageBatchResultEntry> getDeleteMessageBatchResultEntry( ) {
    return deleteMessageBatchResultEntry;
  }

  public void setDeleteMessageBatchResultEntry( ArrayList<DeleteMessageBatchResultEntry> deleteMessageBatchResultEntry ) {
    this.deleteMessageBatchResultEntry = deleteMessageBatchResultEntry;
  }
