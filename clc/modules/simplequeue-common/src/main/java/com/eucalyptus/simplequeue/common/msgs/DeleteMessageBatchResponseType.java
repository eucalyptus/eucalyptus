...
public class DeleteMessageBatchResponseType extends SimpleQueueMessage {
  ...
  private DeleteMessageBatchResult deleteMessageBatchResult = new DeleteMessageBatchResult( );
  ...
  public void setDeleteMessageBatchResult( DeleteMessageBatchResult deleteMessageBatchResult ) {
