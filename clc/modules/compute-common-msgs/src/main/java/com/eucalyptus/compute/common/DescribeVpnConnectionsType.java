...
public class DescribeVpnConnectionsType extends VpcMessage {

  @HttpEmbedded
  private VpnConnectionIdSetType vpnConnectionSet;
  ...
  public void setVpnConnectionSet( VpnConnectionIdSetType vpnConnectionSet ) {
