...
public class DescribePlacementGroupsType extends VmPlacementMessage {
  ...
  private ArrayList<String> placementGroupSet = new ArrayList<String>( );
  @HttpParameterMapping( parameter = "Filter" )
  @HttpEmbedded( multiple = true )
  private ArrayList<Filter> filterSet = new ArrayList<Filter>( );

  public ArrayList<String> getPlacementGroupSet( ) {
    return placementGroupSet;
  }

  public void setPlacementGroupSet( ArrayList<String> placementGroupSet ) {
