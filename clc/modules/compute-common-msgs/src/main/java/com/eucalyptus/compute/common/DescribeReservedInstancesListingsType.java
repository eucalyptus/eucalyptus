...
public class DescribeReservedInstancesListingsType extends ReservedInstanceMessage {
  ...
  private ArrayList<String> reservedInstancesListingId = new ArrayList<String>( );
  ...
  public ArrayList<String> getReservedInstancesListingId( ) {
    return reservedInstancesListingId;
  }

  public void setReservedInstancesListingId( ArrayList<String> reservedInstancesListingId ) {
