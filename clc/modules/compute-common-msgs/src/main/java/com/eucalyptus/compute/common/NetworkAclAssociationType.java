...
public class NetworkAclAssociationType extends EucalyptusData {

  private String networkAclAssociationId;
  private String networkAclId;
  private String subnetId;

  public NetworkAclAssociationType( ) {
  }

  public NetworkAclAssociationType( final String networkAclAssociationId, final String networkAclId, final String subnetId ) {
