...
public class BlockDeviceMappings extends EucalyptusData {
  ...
  private ArrayList<BlockDeviceMappingType> member = new ArrayList<BlockDeviceMappingType>( );
  ...
  public ArrayList<BlockDeviceMappingType> getMember( ) {
    return member;
  }

  public void setMember( ArrayList<BlockDeviceMappingType> member ) {
    this.member = member;
  }
}
