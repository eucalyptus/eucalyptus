...
public class PolicyAuthorization implements Authorization {
  ...
  public PolicyAuthorization(
    ...
    Parameters.checkParam( "effect", effect, notNullValue() );
    Parameters.checkParam( "conditions", conditions, notNullValue( ) );
    Parameters.checkParam( "actions", actions, notNullValue( ) );
    Parameters.checkParam( "resources", resources, notNullValue( ) );
