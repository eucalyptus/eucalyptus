...
@PolicyCondition( { Conditions.NUMERICLESSTHANEQUALS, Conditions.NUMERICGREATERTHANEQUALS_S } )
public class NumericLessThanEquals implements NumericConditionOp {
