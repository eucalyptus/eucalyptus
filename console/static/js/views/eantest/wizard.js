...
function Wizard ( pages, navigationController, closedViewFactory ) {
    ...
    self.makeView = function ( element, options ) {
        options = options || {};
        ...
        var Result = Backbone.View.extend ( {
            initialize: function () {
                ...
                this.nextButton = $ ( '<button/>', {id: 'next', class: 'button', text: 'Next', disabled: !self.hasNext} );
                this.prevButton = $ ( '<button/>', {id: 'prev', class: 'button', text: 'Prev', disabled: !self.hasPrev} );
                this.finishButton = $ ( '<button/>', {id: 'finish', class: 'button', text: 'Finish', disabled: !options.canFinish ( self.position, [] )} );
                this.navPanel = $ ( '<div>', {id: 'wizardNav', class: 'wizardNav'} )
                this.navButtons = $ ( '<div>', {id: 'wizardNavButtons', class: 'wizardNavButtons'} )
                this.problems = $ ( '<div>', {id: 'problems', class: 'problems'} )
                this.navPanel.append(this.navButtons);
                this.navPanel.append(this.problems);
                
                this.$el.append ( this.inner );
                this.$el.append ( this.navPanel );
                this.navButtons.append ( this.prevButton );
                this.navButtons.append ( this.nextButton );
                this.navButtons.append ( this.finishButton );
                this.render ();
            },
            render: function () {
