...
enum { EUCANETD_CVAL_PUBINTERFACE, EUCANETD_CVAL_PRIVINTERFACE, EUCANETD_CVAL_BRIDGE, EUCANETD_CVAL_EUCAHOME, EUCANETD_CVAL_MODE, EUCANETD_CVAL_ADDRSPERNET, EUCANETD_CVAL_SUBNET, EUCANETD_CVAL_NETMASK, EUCANETD_CVAL_BROADCAST, EUCANETD_CVAL_DNS, EUCANETD_CVAL_DOMAINNAME, EUCANETD_CVAL_ROUTER, EUCANETD_CVAL_DHCPDAEMON, EUCANETD_CVAL_DHCPUSER, EUCANETD_CVAL_MACPREFIX, EUCANETD_CVAL_CC_POLLING_FREQUENCY, EUCANETD_CVAL_CLCIP, EUCANETD_CVAL_EUCA_USER, EUCANETD_CVAL_LAST };
