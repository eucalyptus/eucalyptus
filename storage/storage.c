...
int scInitConfig (void)
{
    ...
    snprintf(add_key_command_path, BUFSIZE, EUCALYPTUS_ADD_KEY, home, home);
...
int scMakeInstanceImage (char *userId, char *imageId, char *imageURL, char *kernelId, char *kernelURL, char *ramdiskId, char *ramdiskURL, char *instanceId, char *keyName, char **instance_path, sem * s) 
{
